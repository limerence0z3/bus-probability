import { Row, Col, Button, Input, Space, Progress, Popover } from "antd";
        ...
        case 2:
            return (
                <Row className='luzcenter animate__animated animate__fadeIn' gutter={[0,10]}>
                    <Col span={24}>
                        <Search key={2} placeholder="請輸入路線名稱(例如:A7)" size='large' onSearch={() => setStep(step + 1)} defaultValue={''} />
                    </Col>
                    <Col>
                ...
                <Row className='luzcenter animate__animated animate__fadeIn' gutter={[0,10]}>
                    <Col span={24}>
                        <Row style={{fontSize: '18px', fontWeight: '300',}} justify={'center'}>
                            <Space>
                                <div style={{padding: '3px 10px', backgroundColor:'#5d6e86', color: '#ffffff', borderRadius: '5px'}}>路線：7A</div> 
                            </Space>
                        </Row>
                    </Col>
                    <Col span={24}>
                        <BusCard name='7A' end='加昌站' percent={90} />
                    </Col>
                    <Col span={24}>
                        <BusCard name='7A' end='高師大（燕巢）' percent={70} />
                    </Col>
                    <Col>
